...
for i = 1:19  
    scaledCoordinates(1,i) = maze.textLowerPoint(coordinates.values(1,i),coordinates.values(2,i),1);
    scaledCoordinates(2,i) = maze.textLowerPoint(coordinates.values(1,i),coordinates.values(2,i),2);
end
...
for i = 1:19
    output.values(:,i) = FeedForward([scaledCoordinates(1,i);scaledCoordinates(2,i)],W1, W2);
end
